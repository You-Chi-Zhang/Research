...
mol addfile alanine_dipeptide_converted.pdb

# 2. Run the solvate command
# The solvate plugin uses the 'top' (currently selected) molecule by default.
solvate  alanine_dipeptide.psf alanine_dipeptide_converted.pdb -o solvated -minmax {{-12.5 -12.5 -12.5} {12.5 12.5 12.5}}
